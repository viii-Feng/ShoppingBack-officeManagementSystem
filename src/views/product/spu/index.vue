                ...
                <el-table style="margin: 10px 0px;" border :data="records">
                    ...
                    <el-table-column label="SPU操作">
                        ...
                        <template #="{ row, $index }">
                            ...
                            <el-button type="primary" color="#FF8800" size="small" title="修改SPU"
                                @click="updateSpu(row)">
                                <el-icon color="white"><Edit /></el-icon>
                            </el-button>
                            <el-button type="primary" color="#888888" size="small" title="查看SKU列表"
                                @click="findSku(row)">
                                <el-icon color="white"><View /></el-icon>
                            </el-button>
                            <el-popconfirm :title="`你确定删除${row.spuName}?`" width="200px" @confirm="deleteSpu(row)">
                                <template #reference>
                                    <el-button type="primary" color="#CC0000" size="small" icon="Delete" title="删除SPU"></el-button>
                                </template>
                            </el-popconfirm>
