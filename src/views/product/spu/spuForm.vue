<template>
    <el-form label-width="100px">
            ...
            <el-table border style="margin:10px 0px" :data="saleAttr">
                ...
                <el-table-column label="销售属性值">
                    ...
                    <template #="{ row, $index }">
                        ...
                        <el-input ref="inputRef" @blur="toLook(row)" autofocus v-model="row.saleAttrValue" v-if="row.flag == true"
                            placeholder="请你输入属性值" size="small" style="width:100px"></el-input>
                        <el-button @click="toEdit(row)" color="#00AA00" v-else type="primary" size="small" icon="Plus"></el-button>
                    </template>
                </el-table-column>
        ...
        <el-form-item>
            ...
            <el-button type="primary" siFze="default" @click="cancel">取消</el-button>
        </el-form-item>
    </el-form>
</template>
