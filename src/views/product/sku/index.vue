        ...
        <el-table border style="margin: 10px 0px;" :data="skuArr">
            ...
            <el-table-column label="操作" width="250px" fixed="right">
                <template #="{ row, $index }">
                    ...
                    <el-button type="primary" size="small" color="#FF8800" @click="updateSku">
                        <el-icon color="white"><Edit /></el-icon>
                    </el-button>
                    <el-button type="primary" size="small" color="#888888" @click="findSku(row)">
                        <el-icon color="white"><InfoFilled /></el-icon>
                    </el-button>
                    <el-popconfirm :title="`你确定要删除${row.skuName}?`" width="200px" @confirm="removeSku(row.id)">
                        <template #reference>
                            <el-button type="primary" size="small" color="#CC0000" icon="Delete"></el-button>
                        </template>
                    </el-popconfirm>
                </template>
            </el-table-column>
