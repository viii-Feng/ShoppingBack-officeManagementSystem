<template>
    <el-button size="small" icon="Refresh" title="更新" circle @click="updateRefsh"></el-button>
    <el-button size="small" icon="FullScreen" title="全屏管理" circle @click="fullScreen"></el-button>

    <el-popover placement="bottom" title="主题设置" :width="200" trigger="hover">
        <!-- 表单元素 -->
        <el-form>
            <el-form-item label="主题颜色" style="margin-top: 2px">
                <el-color-picker @change="setColor" v-model="color" size="small" show-alpha :predefine="predefineColors" />
            </el-form-item>
            <el-form-item label="暗黑模式">
                <el-switch @change="changeDark" v-model="dark" class="mt-2"  inline-prompt
